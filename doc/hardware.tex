...
Arbeisspeicher (siehe~\ref{s:ram}) gespeichert.
...
je nach Opcode (die ersten 5 Bits) bestimmen die Ausgänge des Dekodieres, also
die Register, die Rechenoperation, ob das Ergebnis auf dem Arbeitsspeicher
geschrieben werden soll, etc. Wie in Abbildung~\ref{pic:befehlsaufbau} zu sehen,
ist die Angabe von Konstanten in 4, 8 und 16 Bit möglich. Der Grund für die
doch sehr platznehmende 16-Bit-Konstante ist, dass ein Register mit einer
Konstante in einem Befehl befülllt werden soll, wobei alle Register der \ac{EPU}
16 Bit groß sind.
\begin{figure}[htb]
\centering
\begin{tikzpicture}
