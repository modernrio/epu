...
Schnittstelle findet mit einer Bitrate von 115200 bit/s, 8 Datenbits, 1 Stopbit
...
und dadurch die CPU gestoppt, bis ein Byte angekommen ist. Dadurch ist die
Eingabe blockierend, also können keine weiteren Operationen während der Eingabe
durchgeführt werden.
