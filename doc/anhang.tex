...
vorzeichenbehaftet (S=1) oder vorzeichenunbehaftet (S=0) stattfinden soll.
...
ob die Addition vorzeichenbehaftet (S=1) oder vorzeichenunbehaftet (S=0) stattfinden
soll.
...
Subtraktion vorzeichenbehaftet (S=1) oder vorzeichenunbehaftet (S=0) stattfinden
soll.
...
ob die Subtraktion vorzeichenbehaftet (S=1) oder vorzeichenunbehaftet (S=0) stattfinden
soll.
...
\textbf{Hinweis}: Dieser Befehl schiebt gleichzeitig die Rückkehradresse auf den
Stack, damit die Funktion wieder ordnungsgemäß zurückkehren kann.
\clearpage
...
Rückkehradresse wird aus dem Stack entnommen.
\section*{test.r}
\begin{tikzpicture}
	% Bitnummern oben
	\foreach \x in {0,...,15}
